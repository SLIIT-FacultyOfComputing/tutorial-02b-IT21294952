...
int main()
{
    float len, inch; //Declaring variables

    std::cout<<"Length (cm): "; //Prompting user for input
    std::cin>>len;

    inch = len / 2.54; //Calculation

    std::cout<<"Inches:"<< inch<< std::endl; //Displaying the output
